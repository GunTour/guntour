...
export const ButtonEditInfo = () => {
  return (
    <div>
      <button
        id="edit-info"
        className="font-medium text-center justify-center h-11 w-full px-6 py-1 rounded-lg text-white bg-primary transform active:scale-75 transition-transform flex items-center hover:bg-primary hover:text-white "
      >
        <span>Save</span>
      </button>
    </div>
